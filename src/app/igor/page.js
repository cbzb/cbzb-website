...
export default function IgorPage() {
  const especialidades = ['Tributário', 'Planejamento Sucessório e Patrimonial', 'Civil', 'Recuperação de Crédito']
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="aspect-[2/3] bg-primary-dark/40 flex items-center justify-center border-2 border-divider">
            <img src="/Fotos/Igor.png" alt="Igor Barbosa Faria" className="w-full h-full object-cover" />
          </div>
