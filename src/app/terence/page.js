...
export default function TerencePage() {
  const especialidades = ['Tribunais Superiores', 'Trabalhista', 'Desportivo', 'Médico e Hospitalar']
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="aspect-[2/3] bg-primary-dark/40 flex items-center justify-center border-2 border-divider">
            <img src="/Fotos/Terence.png" alt="Terence Zveiter" className="w-full h-full object-cover" />
          </div>
